...
class LocalSearchPM : public IterativeAlg, public Solver<int, int> {
	Q_OBJECT
private:
	//GeneralRandGen* randGen; // Random number generator for the algorithm
	Common::Interfaces::RandGen<Math::uint32>* intRNG; // RNG for integers (uint32)
	Common::Interfaces::RandGen<double>* floatRNG; // RNG for floats (double)
