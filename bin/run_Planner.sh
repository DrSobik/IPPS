...
executable="/data/Projects/IPPS/CPPALG/bin/Planner/Planner";
...
do
  ...
  curTestDir="/data/Projects/IPPS/Tests/Integer_Tests/Tests_Joint/EURO_2013/IPPS/${ddFactor}/${instSize}/ipps_${testpref}$testnum/";
