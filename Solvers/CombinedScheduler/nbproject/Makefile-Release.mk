...
LDLIBSOPTIONS=../LocalSearchPM/builds/Lin64bit/release/libLocalSearchPM.so.1.0.0 ../../Common/builds/Lin64bit/release/libCommon.so.1.0.0
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk builds/Lin64bit/release/libCombinedScheduler.so.1.0.0
