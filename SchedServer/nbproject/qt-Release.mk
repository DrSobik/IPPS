#############################################################################
# Makefile for building: builds/Lin64bit/release/SchedServer
...
INCPATH       = -Inbproject -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtXml -isystem /usr/include/qt5/QtCore -Ibuilds/Lin64bit/release/moc -I/usr/lib64/qt5/mkspecs/linux-g++
...
DISTDIR = /data/Projects/IPPS/CPPALG/SchedServer/builds/Lin64bit/release/obj/SchedServer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = src/SchedServer.cpp \
		src/main.cpp builds/Lin64bit/release/moc/moc_SchedServer.cpp
OBJECTS       = builds/Lin64bit/release/obj/SchedServer.o \
		builds/Lin64bit/release/obj/main.o \
		builds/Lin64bit/release/obj/moc_SchedServer.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Release.pro src/SchedServer.h src/SchedServer.cpp \
		src/main.cpp
QMAKE_TARGET  = SchedServer
DESTDIR       = builds/Lin64bit/release/#avoid trailing-slash linebreak
TARGET        = builds/Lin64bit/release/SchedServer
...
builds/Lin64bit/release/obj/SchedServer.o: src/SchedServer.cpp src/SchedServer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/release/obj/SchedServer.o src/SchedServer.cpp

builds/Lin64bit/release/obj/main.o: src/main.cpp src/SchedServer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/release/obj/main.o src/main.cpp

builds/Lin64bit/release/obj/moc_SchedServer.o: builds/Lin64bit/release/moc/moc_SchedServer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/release/obj/moc_SchedServer.o builds/Lin64bit/release/moc/moc_SchedServer.cpp
