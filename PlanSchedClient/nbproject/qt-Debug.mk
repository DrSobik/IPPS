#############################################################################
# Makefile for building: builds/Lin64bit/debug/SchedClient
...
INCPATH       = -Inbproject -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtWidgets -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtCore -Ibuilds/Lin64bit/debug/moc -I/usr/lib64/qt5/mkspecs/linux-g++
...
DISTDIR = /data/Projects/IPPS/CPPALG/SchedClient/builds/Lin64bit/debug/obj/SchedClient1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = src/QtSSLIssue.cpp \
		...
		src/main.cpp builds/Lin64bit/debug/moc/moc_SchedClient.cpp
OBJECTS       = builds/Lin64bit/debug/obj/QtSSLIssue.o \
		builds/Lin64bit/debug/obj/SchedClient.o \
		builds/Lin64bit/debug/obj/SchedClientDLLInterface.o \
		builds/Lin64bit/debug/obj/main.o \
		builds/Lin64bit/debug/obj/moc_SchedClient.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro src/QtSSLIssue.h \
		src/SchedClient.h \
...
TARGET        = builds/Lin64bit/debug/SchedClient
...
builds/Lin64bit/debug/obj/QtSSLIssue.o: src/QtSSLIssue.cpp src/QtSSLIssue.h \
		src/schedclient_global.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/QtSSLIssue.o src/QtSSLIssue.cpp

builds/Lin64bit/debug/obj/SchedClient.o: src/SchedClient.cpp src/schedclient_global.h \
		src/SchedClient.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/SchedClient.o src/SchedClient.cpp

builds/Lin64bit/debug/obj/SchedClientDLLInterface.o: src/SchedClientDLLInterface.cpp src/SchedClientDLLInterface.h \
		src/schedclient_global.h \
		src/SchedClient.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/SchedClientDLLInterface.o src/SchedClientDLLInterface.cpp

builds/Lin64bit/debug/obj/main.o: src/main.cpp src/SchedClientDLLInterface.h \
		src/schedclient_global.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/main.o src/main.cpp

builds/Lin64bit/debug/obj/moc_SchedClient.o: builds/Lin64bit/debug/moc/moc_SchedClient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/moc_SchedClient.o builds/Lin64bit/debug/moc/moc_SchedClient.cpp
