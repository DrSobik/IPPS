#############################################################################
# Makefile for building: libSBHScheduler.so.1.0.0
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SBHScheduler1.0.0
DISTDIR = /data/Projects/IPPS/CPPALG/Solvers/SBHScheduler/builds/Lin64bit/release/obj/SBHScheduler1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -shared -Wl,-soname,libSBHScheduler.so.1
...
OBJECTS       = builds/Lin64bit/release/obj/DebugExt.o \
		...
		builds/Lin64bit/release/obj/TGScheduler.o \
		builds/Lin64bit/release/obj/TGVNSScheduler.o
...
TARGETA       = builds/Lin64bit/release/libSBHScheduler.a
TARGET0       = libSBHScheduler.so
TARGETD       = libSBHScheduler.so.1.0.0
TARGET1       = libSBHScheduler.so.1
TARGET2       = libSBHScheduler.so.1.0
