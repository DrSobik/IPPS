...
// Backup inorder to modularize

#ifdef OLD

int old_main_VNS(int argc, char *argv[]) {
    // initialize resources, if needed
    // Q_INIT_RESOURCE(resfile);
...
int main_VNS(int argc, char *argv[]) {
    ...
    // Set pointer to the resources
    ippsProblem.rc = &rc;

    // Set pointer to the pmm
    ippsProblem.pmm = &pmm;

    // Library with the planning algorithm
    QString plannerLibName = "VNSPlanner";
    QString plannerName = "VNSPlanner";
