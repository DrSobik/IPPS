#############################################################################
# Makefile for building: builds/Lin64bit/debug/SchedServer
...
INCPATH       = -Inbproject -I. -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtNetwork -isystem /usr/include/qt5/QtXml -isystem /usr/include/qt5/QtCore -Ibuilds/Lin64bit/debug/moc -I/usr/lib64/qt5/mkspecs/linux-g++
...
DISTDIR = /data/Projects/IPPS/CPPALG/SchedServer/builds/Lin64bit/debug/obj/SchedServer1.0.0
LINK          = g++
LFLAGS        = 
...
SOURCES       = src/SchedServer.cpp \
		src/main.cpp builds/Lin64bit/debug/moc/moc_SchedServer.cpp
OBJECTS       = builds/Lin64bit/debug/obj/SchedServer.o \
		builds/Lin64bit/debug/obj/main.o \
		builds/Lin64bit/debug/obj/moc_SchedServer.o
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		nbproject/nbproject/qt-Debug.pro src/SchedServer.h src/SchedServer.cpp \
		src/main.cpp
QMAKE_TARGET  = SchedServer
DESTDIR       = builds/Lin64bit/debug/#avoid trailing-slash linebreak
TARGET        = builds/Lin64bit/debug/SchedServer
...
builds/Lin64bit/debug/obj/SchedServer.o: src/SchedServer.cpp src/SchedServer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/SchedServer.o src/SchedServer.cpp

builds/Lin64bit/debug/obj/main.o: src/main.cpp src/SchedServer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/main.o src/main.cpp

builds/Lin64bit/debug/obj/moc_SchedServer.o: builds/Lin64bit/debug/moc/moc_SchedServer.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o builds/Lin64bit/debug/obj/moc_SchedServer.o builds/Lin64bit/debug/moc/moc_SchedServer.cpp
